...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getAlphazeroPrice() external view returns (uint256) {
        return treasury.getAlphazeroPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            alphazero.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        alphazero.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(share), "AShare");
